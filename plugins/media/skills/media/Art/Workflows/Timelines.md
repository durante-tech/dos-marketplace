...
**Think:** Drafted technical timeline with small illustrations at each milestone
...
3. **Drafted technical timeline** — Organic line connecting events (not ruler-straight)
...
```
Hot Accent Orange #F97316 — Key turning points, critical milestones
Blueprint Navy #1E3A8A — Secondary events, supporting milestones
Blueprint Navy #1E3A8A — All text (dates, labels, annotations)
```

### Background
```
White #FFFFFF or Warm-White Paper #FEF7E0
```

### Color Strategy
- Timeline line in black
- 1-2 most important milestones in orange
- Supporting milestones in navy
- Most events remain black with navy text
...
TURNING POINTS (Orange highlights):
...
TIMELINE STRUCTURE:
- Main line: [Black drafted technical line, slightly measured]
...
COLOR HIGHLIGHTS:
- Orange: [Critical milestone(s)]
- Navy: [Supporting milestone(s)]
...
```
Drafted technical conceptual timeline in editorial illustration style.

STYLE REFERENCE: Illustrated history timeline, drafted technical progress chart, editorial time progression

BACKGROUND: [White #FFFFFF OR Warm-White Paper #FEF7E0] — clean, flat

AESTHETIC:
- Drafted technical timeline (organic line, slightly measured, not ruler-straight)
- Small illustrated metaphors at each milestone
- Variable stroke weight (timeline thicker, details thinner)
- Editorial flat color with strategic orange/navy accents
- Measured but intentional placement
...
- Drafted technical connecting line with slight organic waviness
...
- Size: 60% of Tier 2
- Color: Blueprint Navy #1E3A8A (or Orange/Navy for highlighted events)
...
1. [Year]: [Event name]
   - Illustration: [Small drafted technical icon/metaphor, e.g., "tiny seed sprouting"]
   - Color: Black node with navy text
   - Position: [Along timeline at this point]

2. [Year]: [Critical event]
   - Illustration: [Metaphor, e.g., "lightning bolt"]
   - Color: Hot Accent Orange (#F97316) node and illustration — KEY TURNING POINT
   - Position: [Emphasized size, highlighted]

3. [Year]: [Event name]
   - Illustration: [Metaphor]
   - Color: Blueprint Navy (#1E3A8A) node
...
- Drafted technical engineering-drawing quality, not detailed illustrations
...
- Hot Accent Orange (#F97316) for [1-2 critical turning points] — nodes and illustrations
- Blueprint Navy (#1E3A8A) for [supporting important events]
- Blueprint Navy (#1E3A8A) for all text

CRITICAL REQUIREMENTS:
- Drafted technical timeline (NOT straight digital line)
- Clear temporal progression [left-to-right / top-to-bottom]
- Small illustrated metaphors at each point (simple, sketchy-illustrative)
...
bun Tools/dos-image.ts "[YOUR PROMPT]" \
  ...
  --size=1536x1024 \
  --telemetry-tag=Media/Art/Timelines
```
...
- [ ] **Drafted technical timeline** — Organic line, not digital/straight
- [ ] **Narrative arc visible** — Shows transformation, not just dates
- [ ] **Strategic color** — Orange on critical moments, not everywhere
...
| Problem | Fix |
|---------|-----|
| Timeline too straight | "Organic drafted technical line, slight waviness, measured curve" |
...
| Looks corporate | Reference "editorial illustration style, drafted technical engineering-drawing aesthetic" |
...
- **Color:** Orange on "Deep Learning Breakthrough" (2012)
...
- 1-2 critical moments: Orange
- Supporting events: Navy
- Text: Navy
