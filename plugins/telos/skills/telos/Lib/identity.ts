/**
 * Pack-local shim → canonical `~/.claude/hooks/lib/identity.ts`.
 *
 ...
 * `~/.claude/skills/<P>/Lib/identity.ts` paths (the dual-path-resolution gap).
 *
...
const canonical = join(homedir(), '.claude/hooks/lib/identity.ts');
// eslint-disable-next-line @typescript-eslint/no-require-imports
const mod = require(canonical);

export const getPrincipal: typeof import('../../../../../.claude/hooks/lib/identity').getPrincipal = mod.getPrincipal;
