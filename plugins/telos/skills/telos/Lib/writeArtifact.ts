/**
 * Pack-local shim → canonical `~/.claude/hooks/lib/writeArtifact.ts`.
 *
 ...
 * `~/.claude/skills/<P>/Lib/writeArtifact.ts` paths (the dual-path-resolution gap).
 *
...
const canonical = join(homedir(), '.claude/hooks/lib/writeArtifact.ts');
// eslint-disable-next-line @typescript-eslint/no-require-imports
const mod = require(canonical);

export const writeArtifact: typeof import('../../../../../.claude/hooks/lib/writeArtifact').writeArtifact = mod.writeArtifact;
