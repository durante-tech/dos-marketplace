...
pack-id: durante-contentanalysis-v1.0.0
version: 1.0.0
author: durante-tech
...
- **Files:** 3
- **Hooks registered:** 0
- **Dependencies:** None (works standalone, enhanced by DOS voice and writing style configuration)
...
If DOS is installed, the extraction voice is calibrated from:
- `~/.claude/DOS/USER/WRITINGSTYLE.md` -- Canonical voice definition
- `~/.claude/DOS/USER/SKILLCUSTOMIZATIONS/ExtractWisdom/` -- Skill-specific preferences
...
- **Original concept:** Daniel Miessler -- developed as the next generation of [extract_wisdom](https://github.com/danielmiessler/fabric) within the [PAI](https://github.com/durante-tech/dos) system
...
- **DOS Writing Style** -- Voice definition that calibrates extraction tone
...
- **DOS Voice Infrastructure** -- Audio narration of extraction results
