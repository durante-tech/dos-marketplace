...
description: Deep-dive a specific upgrade opportunity and produce an actionable implementation plan.
status: STABLE
---
...
3. Map to the user's DOS architecture
...
### Opportunity
[What this enables in your DOS setup]
