...
`~/.claude/DOS/USER/SKILLCUSTOMIZATIONS/Fabric/`
...
Instead of calling `fabric -p pattern_name`, DOS executes patterns natively:
...
### 2026-01-18
- Initial skill creation (extracted from DOS/Tools/fabric)
