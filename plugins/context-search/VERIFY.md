...
echo "Data sources:"
[ -f "$CLAUDE_DIR/MEMORY/STATE/work.json" ] && echo "  AVAILABLE work.json (session registry)" || echo "  UNAVAILABLE work.json (install DOS for this)"
[ -d "$CLAUDE_DIR/MEMORY/WORK" ] && echo "  AVAILABLE MEMORY/WORK (PRD directory)" || echo "  UNAVAILABLE MEMORY/WORK (install DOS for this)"
[ -f "$CLAUDE_DIR/MEMORY/STATE/session-names.json" ] && echo "  AVAILABLE session-names.json" || echo "  UNAVAILABLE session-names.json (install DOS for this)"
