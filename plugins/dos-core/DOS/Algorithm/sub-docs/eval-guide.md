...
- ISC criteria in eval-mode PRDs are guard rails (invariant assertions)
- Eval criteria in PRD frontmatter are the optimization signal
- Both live in the PRD but serve different roles
