...
**Self-differentiation:** Unlike RedTeam (attacks an argument for fatal flaws NOW), WorldThreatModelHarness tests an idea/strategy/investment across 11 time horizons. It OWNS the literal *test idea* / TestIdea workflow and the temporal *stress-test against the future*; non-temporal attacks defer to RedTeam, and empirical/measure intent defers to Science.

## Workflow Routing

| Trigger | Workflow | Description |
|---------|----------|-------------|
| "test idea", "test strategy", "test investment", "how will this hold up", "stress-test against the future", "test against future" | `Workflows/TestIdea.md` | Test any input against all 11 world models |
...
Models are stored at: `$DOS_DIR/MEMORY/RESEARCH/WorldModels/`
...
This skill orchestrates multiple DOS capabilities:
...
`~/.claude/DOS/USER/SKILLCUSTOMIZATIONS/WorldThreatModelHarness/`
