...
if [ -n "$PERPLEXITY_API_KEY" ]; then
  ...
  echo "  AVAILABLE Perplexity API key (DOS .env)"
else
...
if [ -d "$CLAUDE_DIR/MEMORY" ]; then
  echo "  AVAILABLE DOS MEMORY (research artifacts will persist)"
else
  echo "  UNAVAILABLE DOS MEMORY (deep investigation vault requires this)"
fi
