---
name: Thinking
pack-id: durante-thinking-v1.0.0
version: 1.0.0
author: durante-tech
...
|--------------|----------|---------|
| Skill customizations | `~/.claude/DOS/USER/SKILLCUSTOMIZATIONS/{ModeName}/` | Per-user preferences and overrides for each thinking mode |
...
- **DOS Algorithm** -- The structured workflow system that can invoke Thinking modes during complex multi-phase work
- **DOS Agents Skill** -- Custom agent composition that can leverage Thinking modes for specialized analysis
