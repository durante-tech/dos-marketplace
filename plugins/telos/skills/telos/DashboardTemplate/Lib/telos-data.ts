...
// ONE canonical TELOS-corpus resolver for the dashboard app (telos-dir.ts);
// every reader/writer route imports it so the app can never split-brain its
// read dir against its write dir again.
