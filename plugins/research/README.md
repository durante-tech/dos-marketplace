---
name: Research
pack-id: durante-research-v1.0.0
version: 1.0.0
author: durante-tech
...
- **Working files:** `MEMORY/WORK/{current_work}/` (tied to active work item, relative to cwd)
...
Create `~/.claude/DOS/USER/SKILLCUSTOMIZATIONS/Research/PREFERENCES.md` to define:
...
- **DOS OSINT Skill** -- For company/person background checks and due diligence (Research routes to OSINT for these)
- **DOS Scraping Skill** -- For advanced web scraping when Research's content retrieval needs escalation
...
- **DOS Blogging Skill** -- Research feeds directly into blog post creation
- **DOS Newsletter Skill** -- Research feeds into newsletter content
