...
description: Interactive D3.js data visualizations from raw datasets
status: BETA
featured: true
icon: BarChart3
bestPath:
  - title: "Data Ingestion"
    description: "Parse raw datasets and normalize into visualization-ready structures."
  - title: "Chart Selection"
    description: "Select optimal chart types based on data shape and insight goals."
  - title: "D3.js Composition"
    description: "Build interactive D3 visualizations with axes, legends, and tooltips."
  - title: "Interactive Export"
    description: "Export as standalone HTML with full interactivity and responsive scaling."
---
...
## Color Palette (DOS Standard)

**Primary Colors:**
```
Hot Accent Orange: #F97316   - Brand accent
Blueprint Navy:   #1E3A8A   - Secondary accent
Navy:    #1E3A8A   - Text and lines
```
...
nodes.forEach(node => {
  node.color = node.isBlocker ? '#D32F2F' : '#F97316';
});
```
...
bars.attr('fill', d => d.isBottleneck ? '#D32F2F' : '#1E3A8A');
```
