...
**Personal TELOS** -- Your life context system stored at `~/.durante/user/TELOS/`:
...
Personal TELOS requires the TELOS files to exist at `~/.durante/user/TELOS/`. These are created as part of DOS setup, not by this skill pack.

| Configuration | Location | Purpose |
|--------------|----------|---------|
| Personal TELOS files | `~/.durante/user/TELOS/` | Life context: beliefs, goals, books, wisdom, etc. |
...
| Skill customizations | `~/.claude/DOS/USER/SKILLCUSTOMIZATIONS/Telos/` | Per-user preferences and overrides |
...
- **DOS USER Directory** -- The `~/.durante/user/TELOS/` directory where personal TELOS files live
- **DOS Algorithm** -- The structured workflow system that coordinates multi-phase analysis and report generation
