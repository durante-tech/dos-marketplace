...
**All levels use the same voice, tone rules, and quality standards.** Structure changes; voice, tone rules, and quality standards stay stable. An Instant extraction should hit just as hard per-bullet as a Comprehensive one.
...
**Canonical voice reference: `DOS/USER/WRITINGSTYLE.md`** — read this file for the full voice definition. The bullets should sound like {PRINCIPAL.NAME} telling a friend about it over coffee. Not compressed info nuggets. Not clever one-liners. Actual spoken observations.

**THREE LEVELS — we're aiming for Level 3:**

**Level 1 (BAD — documentation):**
<!-- brand-voice:exempt — quoted talk content illustrating wisdom-extraction Level 1 -->
...
<!-- brand-voice:exempt — quoted talk content illustrating wisdom-extraction Level 2 -->
...
<!-- brand-voice:exempt — quoted talk content illustrating wisdom-extraction Level 3 -->
...
> Source: {source_url}   <!-- the YouTube/article URL, the file path, or "pasted — no URL" -->
