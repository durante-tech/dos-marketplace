...
- Any diagram where Mermaid structure + drafted technical aesthetic is ideal
...
1. **Measured boxes** — Rectangles with rough, drafted technical edges (not perfect)
2. **Sketchy arrows** — Arrows with slight wobble, not ruler-straight
3. **Rough edges** — Everything has organic measuredion
4. **Drafted monospace text** — Labels look handwritten, not typed
...
### Flow Emphasis
```
Hot Accent Orange #F97316 — Critical path, main flow, important states
Blueprint Navy #1E3A8A — Alternative paths, secondary flows, supporting states
Blueprint Navy #1E3A8A — All text labels and annotations
```

### Background
```
Warm-White Paper #FEF7E0 — Whiteboard/sketch paper feel
OR
...
**Flowcharts:**
- Main path boxes: Orange outlines
- Alternative branches: Navy outlines
- Decision diamonds: Black outlines
- All connecting arrows: Black

**Sequence Diagrams:**
- Critical actor/entity: Orange box
- Secondary actors: Navy boxes
- All messages/arrows: Black
- Activation boxes: Orange fills (subtle)

**State Diagrams:**
- Active/important states: Orange
- Transition states: Navy
- Terminal states: Black
- Arrows: Black with labels

**Class/ER Diagrams:**
- Key entities: Orange boxes
- Related entities: Navy boxes
...
NODES:
- Start: [Label]
- Process 1: [Action description] (rectangle, orange)
- Decision 1: [Question] (diamond, black)
- Process 2a: [Action if yes] (rectangle, orange)
- Process 2b: [Action if no] (rectangle, navy)
...
(This path highlighted with orange boxes)
```
...
**Plan the whiteboard engineering-drawing aesthetic:**
...
```
Instead of: ◇
This:       ◊  (measured, asymmetric, drafted technical diamond)
```
...
This:       Drafted monospace appearance, slight slant, measured
```

#### C. Visual Hierarchy
- **Primary path/flow:** Orange boxes, thicker lines
- **Secondary paths:** Navy boxes, standard lines
- **Structure/framework:** Black lines and shapes
- **Labels/text:** Navy, drafted monospace style
...
- All boxes: Measured rectangles, slightly tilted
- Arrows: Gentle curves even when "straight"
- Diamonds: Asymmetric, drafted technical feel
- Circles: Slightly oval, measured
- Text: Drafted monospace, natural slant
...
```
Drafted technical Mermaid [DIAGRAM TYPE] in Excalidraw whiteboard sketch style.

STYLE REFERENCE: Excalidraw whiteboard diagram, drafted technical flowchart, sketchy-illustrative technical diagram

BACKGROUND: [Warm-White Paper #FEF7E0 / White #FFFFFF] — whiteboard/sketch paper feel

AESTHETIC:
- Excalidraw drafted technical style (measured, sketchy-illustrative, organic)
- Whiteboard engineering-drawing quality (looks drafted technical, not digital)
...
- Drafted monospace text labels (measured alignment, natural slant)
...
- Style: Drafted technical interpretation, slightly measured
...
- Size: 60% of Tier 2
- Color: Hot Accent Orange #F97316 or Blueprint Navy #1E3A8A
...
- Label: "[Label text]"
- Style: Measured drafted technical edges, slightly asymmetric
- Color: Black (#000000) outline, no fill OR subtle warm-white fill
- Size: [Relative size]
...
- Style: Measured lines, slightly tilted, drafted measuredion
- Color: Hot Accent Orange (#F97316) outline — CRITICAL PATH
- Fill: Light warm-white or transparent
- Size: [Relative size]
- Position: [Below Node 1]

NODE 3: [Type - e.g., DECISION DIAMOND]
- Shape: Diamond/rhombus with measured edges
- Label: "[Question?]"
- Style: Drafted technical, asymmetric diamond, organic edges
- Color: Black (#000000) outline
- Fill: Transparent or very warm-white paper
- Size: [Relative size]
...
- Style: Measured lines, slightly tilted
- Color: Blueprint Navy (#1E3A8A) outline — SECONDARY PATH
- Fill: Light warm-white or transparent
- Size: [Relative size]
...
- Style: Drafted technical, organic curves
- Color: Black (#000000) outline
...
- Style: Sketchy drafted technical arrow, slight curve even if "straight"
- Path: [Describe route, e.g., "curves gently from Node 1 down to Node 2"]
- Color: Black (#000000)
- Label: [Optional label text, e.g., "process" or condition]
- Arrowhead: Drafted technical triangle, slightly asymmetric
...
[For Sequence Diagrams:]
- Actor boxes: Drafted technical rectangles at top
- Lifelines: Dashed vertical lines (drafted technical, measured)
- Activation boxes: Rectangles on lifelines (orange for key)
- Messages: Arrows between lifelines with labels

[For State Diagrams:]
- Initial state: Filled circle (drafted technical)
- Final state: Double circle (measured concentric circles)
- State boxes: Rounded rectangles with rough edges
- Transition arrows: Curved arrows with condition labels

[For Class/ER Diagrams:]
- Class boxes: Three-section rectangles (measured dividers)
...
- Hot Accent Orange (#F97316): Critical path nodes, main flow, key entities (10-20% of nodes)
- Blueprint Navy (#1E3A8A): Alternative paths, secondary entities (5-10% of nodes)
- Blueprint Navy (#1E3A8A): All text labels (node labels, arrow labels)
- Background: Warm-White Paper (#FEF7E0) OR White (#FFFFFF)

CRITICAL REQUIREMENTS:
- Excalidraw drafted technical aesthetic (measured, sketchy-illustrative, organic)
- Mermaid diagram structure ([chosen type] grammar)
- brand color scheme (orange for critical, navy for secondary, black structure)
- 3-tier typography (title, node labels, edge labels)
- Whiteboard sketch feel (not polished, not digital)
- All shapes measured (rectangles measured, circles oval, arrows curved)
- Variable line weight (thicker boxes, medium arrows, thin details)
- Drafted monospace text (natural slant, measured alignment)
...
- Does it look drafted technical on a whiteboard (not digital)?
- Are all geometric shapes measured (measured edges)?
- Is the diagram type structure clear (flowchart/sequence/state/etc.)?
- Can you follow the flow/logic/sequence easily?
- Is the critical path obvious (orange highlights)?
- Are labels readable despite drafted monospace style?
...
```bash
bun Tools/dos-image.ts "[YOUR COMPREHENSIVE PROMPT]" \
  --intent=diagram \
  --output=/path/to/mermaid-diagram.png \
  --size=1024x1024 \
  --telemetry-tag=Media/Art/Mermaid
```

**Why Nano Banana Pro:**
- Best text rendering (critical for labels on nodes and arrows)
- Handles complex multi-element compositions
- Can render drafted technical aesthetic while maintaining readability
...
```bash
bun ~/.claude/DOS/Tools/RemoveBg.ts /path/to/mermaid-diagram.png
```
...
- [ ] **Drafted technical feel:** Looks sketched on whiteboard
- [ ] **Measured shapes:** No perfect rectangles/circles
- [ ] **Sketchy arrows:** Organic curves, not ruler-straight
- [ ] **Measured text:** Drafted monospace, natural slant
- [ ] **Variable line weight:** Thicker boxes, thinner details
- [ ] **Organic joins:** Connections look natural

#### Brand Editorial Style
- [ ] **Color strategic:** Orange on critical (10-20%), navy on secondary (5-10%)
...
#### Readability & Clarity
- [ ] **Labels readable:** All text legible despite drafted technical style
- [ ] **Flow obvious:** Can follow the diagram easily
- [ ] **Critical path clear:** Orange highlights guide eye
...
|---------|-----------|-----|
| **Too polished/digital** | Missing Excalidraw aesthetic | Emphasize: "Measured rectangles, sketchy-illustrative arrows, drafted technical on whiteboard, measured shapes" |
| **Perfect geometry** | Shapes too clean | "All rectangles with rough edges, circles slightly oval, organic measuredion throughout" |
| **Can't follow flow** | Unclear structure | Strengthen arrow directions, add labels, clarify critical path with orange |
| **Labels unreadable** | Text too sketchy-illustrative or small | Increase label size, simplify hand-lettering: "Readable drafted monospace style" |
...
| **Color overload** | Too much orange/navy | Limit: "Orange on 2-3 critical nodes only, navy on 1-2 secondary, rest black" |
| **Looks generic** | Missing brand or Excalidraw style | Combine both: "Excalidraw measured whiteboard sketch + brand orange/navy strategic accents" |
...
**Node Types:**
- **Start/End:** Rounded rectangles (measured ovals)
- **Process:** Rectangles with rough edges
- **Decision:** Diamonds (asymmetric, drafted technical)
- **Input/Output:** Parallelograms (tilted, measured)
...
**Color Strategy:**
- Orange: Main success/happy path
- Navy: Error handling or alternative paths
...
**Components:**
- **Actors/Entities:** Boxes at top (measured rectangles)
- **Lifelines:** Vertical dashed lines (drafted technical, measured)
...
**Color Strategy:**
- Orange: Critical actor/main entity
- Navy: Secondary actors
- Black: All messages/arrows
- Orange fill: Activation bars for critical entity
...
**Components:**
- **States:** Rounded rectangles (measured)
- **Initial state:** Filled circle (drafted technical blob)
- **Final state:** Double circle (concentric measured circles)
...
**Color Strategy:**
- Orange: Active/current/important states
- Navy: Intermediate states
...
**Color Strategy:**
- Orange: Core/important entities
- Navy: Related entities
- Black: All relationship lines
- Navy: All attribute/method text
...
**Structure:** Start → Enter Credentials → Valid? → [Yes] → Generate Token → Success
                                                   → [No] → Retry Limit? → [Yes] → Lock Account
                                                                         → [No] → Return to Enter
**Color:** Orange on success path, Navy on error handling
...
**Color:** Orange on Gateway (critical), Navy on Auth (secondary)
...
**Structure:** Initial → Pending → Processing → Shipped → Delivered → Final
                               → (error) → Cancelled
**Color:** Orange on happy path states, Navy on processing, Black on cancelled
**Aspect:** 1:1 square
...
**Color:** Orange on User and Post (core), Navy on Comment and Category
**Aspect:** 16:9 horizontal
...
- Want drafted technical whiteboard aesthetic (Excalidraw style)
- Deriving diagram from content analysis (not manually specified)

### Mermaid vs Technical Diagrams
- **Mermaid:** Structured diagram types (flowchart, sequence, etc.), Excalidraw sketchy-illustrative aesthetic
- **Technical:** Freeform architecture diagrams, cleaner drafted technical style
...
4. Design Excalidraw layout (measured, sketchy-illustrative, whiteboard)
...
3. **Excalidraw aesthetic:** Drafted technical whiteboard sketch feel
4. **brand color scheme:** Strategic orange/navy, black structure
5. **Readable measuredion:** Sketchy but clear
