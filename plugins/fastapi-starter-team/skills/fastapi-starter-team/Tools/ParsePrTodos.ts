...
//   - [ ] (agent:backend) (priority:high) (file:src/app/api/v1/users.py:42) Move auth check
...
//
// Sibling: MakerkitTeam/Tools/ParsePrTodos.ts. Same shape, FastAPI-flavored
// AgentId union: apidx/schema/agent replace ux/ui/frontend.
