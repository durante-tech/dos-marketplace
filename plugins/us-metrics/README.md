---
name: USMetrics
pack-id: durante-usmetrics-v1.0.0
version: 1.0.0
author: durante-tech
...
AI responds:
Running the UpdateData workflow in the us-metrics skill to fetch live data...
...
AI responds:
Running the GetCurrentState workflow in the us-metrics skill to analyze trends...
...
Create a customization directory at `~/.claude/DOS/USER/SKILLCUSTOMIZATIONS/USMetrics/` with a `PREFERENCES.md` file to override default behavior (e.g., focus categories, output format preferences, custom data paths).
...
- **DOS Substrate** -- The dataset infrastructure that stores the metrics this skill fetches and analyzes
- **DOS Algorithm** -- The structured workflow system that can use economic data in research and analysis tasks

---

## Works Well With

- **DOS Core Install** -- Provides the infrastructure and data directories USMetrics operates on
