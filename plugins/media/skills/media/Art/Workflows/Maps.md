...
**Think:** Drafted patent-style map, but for conceptual territories
...
3. **Drafted technical** — Measured coastlines, measured borders, human quality
...
Light fills — Very subtle warm-white/beige for different territories
```

### Domain Differentiation
```
Hot Accent Orange #F97316 — Primary domain or "optimal" territory
Blueprint Navy #1E3A8A — Secondary domain or adjacent territory
Blueprint Navy #1E3A8A — All labels and annotations
```

### Background (Water/Space)
```
Warm-White Paper #FEF7E0 — Warm neutral "ocean"
OR
...
- Territories subtly differentiated by color (orange, navy, or just labeled)
- Background as "ocean" or empty space
- Text all navy for readability
...
- Center: Large continent of [Primary Domain] (orange)
- East: Island of [Domain 2] (navy)
- West: Peninsula of [Domain 3] connected to center
- North: Mountain range representing [Barrier]
- South: Ocean of [Unknown Territory]

FEATURES:
- Coastlines: All drafted technical, measured, measured
...
COLOR CODING:
- [Primary territory]: Hot Accent Orange (#F97316) subtle fill
- [Secondary territory]: Blueprint Navy (#1E3A8A) subtle fill
- Other territories: Light warm-white or white
...
```
Drafted technical conceptual map in editorial cartography style.

STYLE REFERENCE: Fantasy map, drafted technical cartography, illustrated territory map

BACKGROUND: [Warm-White Paper #FEF7E0 / White #FFFFFF] — represents ocean/empty space

AESTHETIC:
- Drafted technical map (measured coastlines, measured borders)
- Cartographic elements (territories, features, labels)
- Variable stroke weight (coastlines thicker, details thinner)
- Editorial flat color with strategic orange/navy territories
- Engineering-drawing quality, not polished digital map
...
- Coastline: Drafted measured black line
- Fill: Subtle Hot Accent Orange (#F97316) tint (very light, not solid)
...
- Coastline: Drafted technical irregular outline
- Fill: Subtle Blueprint Navy (#1E3A8A) tint
...
- Coastline: Measured navy line
- Fill: Light warm-white or white (minimal color)
...
GEOGRAPHIC FEATURES:
- Mountain range: Drafted technical peaks along [border/territory]
  - Represents: [Barrier or challenge]
  - Color: Black (#000000) linework
  - Label: "*mountains of [X]*" in italic

- Rivers: Measured flowing lines connecting territories
...
- Compass rose: Small decorative compass in corner (optional)
  - Drafted, technical
  - Hot Accent Orange (#F97316) north arrow
...
- Hot Accent Orange (#F97316) subtle fill on [primary territory]
- Blueprint Navy (#1E3A8A) subtle fill on [secondary territory]
- Light warm-white/white fills on other territories
- Blueprint Navy (#1E3A8A) for all text labels

CRITICAL REQUIREMENTS:
- Drafted technical cartographic style (measured lines, measured shapes)
...
- [ ] **Drafted technical** — Measured coastlines, measured borders, human quality
- [ ] **Strategic color** — Orange/navy on key territories (subtle fills)
...
| Problem | Fix |
|---------|-----|
| Too precise/digital | "Drafted measured coastlines, measured irregular borders, engineering-drawing quality" |
...
- **Territories:** Reasoning (center, orange), Creativity (island, navy), Perception (west peninsula), Action (east island)
...
- Primary territory: Orange (subtle fill)
- Secondary territory: Navy (subtle fill)
