/**
 * Pack-local shim → canonical `~/.claude/hooks/lib/project-context.ts`.
 *
 ...
 * `~/.claude/skills/<P>/Lib/project-context.ts` paths (the dual-path-resolution gap).
 *
...
const canonical = join(homedir(), '.claude/hooks/lib/project-context.ts');
// eslint-disable-next-line @typescript-eslint/no-require-imports
const mod = require(canonical);

export const isDosTenantPath: typeof import('../../../../../.claude/hooks/lib/project-context').isDosTenantPath = mod.isDosTenantPath;
