...
```bash
bash "$DOS_DIR/DOS/Tools/voice.sh" custom --voice-id fTtv3eikoepIosk8dTZ5 "Checking current world model state"
```

### Step 2: Read INDEX

Read `$DOS_DIR/MEMORY/RESEARCH/WorldModels/INDEX.md`.
