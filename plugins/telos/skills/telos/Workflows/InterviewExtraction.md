---
name: Interview Extraction
description: Extracts standardized insights from interview transcripts and notes into 13 categorized output files — differentiators, findings, complaints, gaps, and more.
status: STABLE
bestPath:
  - title: "Discovery"
    description: "Scan the target directory and build an inventory of text-based interview files."
  - title: "Deep Analysis (Ultrathink)"
    description: "Read each file and classify content into the 13 extraction categories."
  - title: "Consolidation"
    description: "Aggregate extractions per category, deduplicate, and order by significance."
  - title: "Output Generation"
    description: "Generate the 13 categorized output files at the target directory's top level."
  - title: "Summary Report"
    description: "Report category counts and notable cross-cutting patterns."
---
...
- User says "extract content", "extract telos content", "extract interviews", or "analyze interviews"
- TELOS skill is run on a directory containing interview notes, transcripts, or meeting notes
- User needs raw interview material sorted into structured, sourced categories before running CreateNarrativePoints or WriteReport
