...
`~/.claude/DOS/USER/SKILLCUSTOMIZATIONS/Aphorisms/`
...
**Location:** `~/.claude/skills/utilities/Aphorisms/Database/aphorisms.md`
...
**Database Location:**
`~/.claude/skills/utilities/Aphorisms/Database/aphorisms.md`
