#!/usr/bin/env bun
/**
 * RenderTemplate.ts - DOS Templating Engine
 *
...
export async function renderTemplate(options: RenderOptions): Promise<string> {
  ...
  if (options.outputPath) {
    ...
    await writeArtifact(outputFullPath, rendered, {
      pack: 'Utilities/Prompting',
      workflow: 'RenderTemplate',
      title: basename(outputFullPath),
    });
