/**
 * Pack-local shim → canonical `~/.claude/hooks/lib/atomic-write.ts`.
 *
 ...
 * `~/.claude/skills/<P>/Lib/atomic-write.ts` paths (the dual-path-resolution gap).
 *
...
const canonical = join(homedir(), '.claude/hooks/lib/atomic-write.ts');
// eslint-disable-next-line @typescript-eslint/no-require-imports
const mod = require(canonical);

export const atomicWriteSync: typeof import('../../../../../.claude/hooks/lib/atomic-write').atomicWriteSync = mod.atomicWriteSync;
export const withFileLock: typeof import('../../../../../.claude/hooks/lib/atomic-write').withFileLock = mod.withFileLock;
