---
name: Context Search
pack-id: durante-context-search-v1.1.0
version: 1.1.0
author: durante-tech
...
**DOS-enhanced installs (additional sources):**
...
8. **DOS Git History** — Commits in the DOS infrastructure repo
...
- **Files created:** 2
- **Hooks registered:** 0
- **Dependencies:** None (works standalone, enhanced by DOS MEMORY structure)
...
If these paths don't exist (e.g., DOS's MEMORY system isn't installed), the command gracefully returns "no matches found" for those sources. No errors, no crashes.
...
- **DOS MEMORY System** — The work tracking infrastructure that generates the data this command searches
- **DOS Algorithm** — The system that creates PRDs with structured criteria, decisions, and verification

---

## Works Well With

- **DOS Core Install** — Provides the MEMORY directory structure for full functionality
- **DOS Algorithm Skill** — Generates the PRDs that Context Search searches
