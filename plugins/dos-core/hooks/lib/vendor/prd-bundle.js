// @bun @bun-cjs
// ───────────────────────────────────────────────────────────────────────
// GENERATED by Tools/bundle-hook-deps.ts (RFC-0112 A1) — DO NOT EDIT.
// Self-contained vendored bundle: @durante/prd + yaml, for fresh installs
// with no node_modules. Rebuild: bun ~/Durante/Tools/bundle-hook-deps.ts
// Parity with workspace source is gated by the A4 test (bundle-hook-deps.test.ts).
// ───────────────────────────────────────────────────────────────────────
...
var require_visit2 = __commonJS((exports2) => {
...
var require_directives2 = __commonJS((exports2) => {
  var identity = require_identity2();
...
var require_anchors2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var visit = require_visit2();
  function anchorIsValid(anchor) {
    if (/[\x00-\x19\s,[\]{}]/.test(anchor)) {
...
var require_applyReviver2 = __commonJS((exports2) => {
  function applyReviver(reviver, obj, key, val) {
    if (val && typeof val === "object") {
      if (Array.isArray(val)) {
        for (let i = 0, len = val.length;i < len; ++i) {
...
var require_toJS2 = __commonJS((exports2) => {
  var identity = require_identity2();
  function toJS(value, arg, ctx) {
    if (Array.isArray(value))
      return value.map((v, i) => toJS(v, String(i), ctx));
...
var require_Alias2 = __commonJS((exports2) => {
...
var require_Scalar2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var Node = require_Node2();
  var toJS = require_toJS2();
  var isScalarValue = (value) => !value || typeof value !== "function" && typeof value !== "object";
...
var require_createNode2 = __commonJS((exports2) => {
...
var require_Collection2 = __commonJS((exports2) => {
...
var require_stringifyComment2 = __commonJS((exports2) => {
  var stringifyComment = (str) => str.replace(/^(?!$)(?: $)?/gm, "#");
  function indentComment(comment, indent) {
    if (/^\n+$/.test(comment))
      return comment.substring(1);
...
var require_foldFlowLines2 = __commonJS((exports2) => {
  var FOLD_FLOW = "flow";
  var FOLD_BLOCK = "block";
  var FOLD_QUOTED = "quoted";
  function foldFlowLines(text, indent, mode = "flow", { indentAtStart, lineWidth = 80, minContentWidth = 20, onFold, onOverflow } = {}) {
...
var require_stringifyString2 = __commonJS((exports2) => {
  var Scalar = require_Scalar2();
...
var require_stringifyPair2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var Scalar = require_Scalar2();
...
var require_addPairToJSMap2 = __commonJS((exports2) => {
...
var require_Pair2 = __commonJS((exports2) => {
  var createNode = require_createNode2();
...
var require_stringifyCollection2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var stringify = require_stringify2();
  var stringifyComment = require_stringifyComment2();
  function stringifyCollection(collection, ctx, options) {
...
var require_YAMLMap2 = __commonJS((exports2) => {
...
var require_map2 = __commonJS((exports2) => {
  var identity = require_identity2();
...
var require_YAMLSeq2 = __commonJS((exports2) => {
  var createNode = require_createNode2();
  var stringifyCollection = require_stringifyCollection2();
  var Collection = require_Collection2();
  var identity = require_identity2();
...
var require_seq2 = __commonJS((exports2) => {
  var identity = require_identity2();
...
var require_bool3 = __commonJS((exports2) => {
  var Scalar = require_Scalar2();
  var boolTag = {
    identify: (value) => typeof value === "boolean",
    default: true,
...
var require_stringifyNumber2 = __commonJS((exports2) => {
  function stringifyNumber({ format, minFractionDigits, tag, value }) {
    if (typeof value === "bigint")
      return String(value);
    const num = typeof value === "number" ? value : Number(value);
...
var require_float3 = __commonJS((exports2) => {
  var Scalar = require_Scalar2();
...
var require_int3 = __commonJS((exports2) => {
  var stringifyNumber = require_stringifyNumber2();
  var intIdentify = (value) => typeof value === "bigint" || Number.isInteger(value);
  var intResolve = (str, offset, radix, { intAsBigInt }) => intAsBigInt ? BigInt(str) : parseInt(str.substring(offset), radix);
  function intStringify(node, radix, prefix) {
...
var require_schema4 = __commonJS((exports2) => {
...
var require_schema5 = __commonJS((exports2) => {
  var Scalar = require_Scalar2();
  var map = require_map2();
  var seq = require_seq2();
  function intIdentify(value) {
...
var require_binary2 = __commonJS((exports2) => {
  var node_buffer = require("buffer");
  var Scalar = require_Scalar2();
  var stringifyString = require_stringifyString2();
  var binary = {
...
var require_pairs2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var Pair = require_Pair2();
  var Scalar = require_Scalar2();
  var YAMLSeq = require_YAMLSeq2();
...
var require_omap2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var toJS = require_toJS2();
  var YAMLMap = require_YAMLMap2();
  var YAMLSeq = require_YAMLSeq2();
...
var require_bool4 = __commonJS((exports2) => {
  var Scalar = require_Scalar2();
  function boolStringify({ value, source }, ctx) {
    const boolObj = value ? trueTag : falseTag;
    if (source && boolObj.test.test(source))
...
var require_float4 = __commonJS((exports2) => {
  var Scalar = require_Scalar2();
  var stringifyNumber = require_stringifyNumber2();
  var floatNaN = {
    identify: (value) => typeof value === "number",
...
var require_int4 = __commonJS((exports2) => {
  var stringifyNumber = require_stringifyNumber2();
  var intIdentify = (value) => typeof value === "bigint" || Number.isInteger(value);
  function intResolve(str, offset, radix, { intAsBigInt }) {
    const sign = str[0];
...
var require_set2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var Pair = require_Pair2();
  var YAMLMap = require_YAMLMap2();
...
var require_timestamp2 = __commonJS((exports2) => {
  var stringifyNumber = require_stringifyNumber2();
  function parseSexagesimal(str, asBigInt) {
    const sign = str[0];
    const parts = sign === "-" || sign === "+" ? str.substring(1) : str;
...
var require_schema6 = __commonJS((exports2) => {
  var map = require_map2();
  var _null = require_null2();
  var seq = require_seq2();
  var string = require_string2();
...
var require_tags2 = __commonJS((exports2) => {
  var map = require_map2();
  var _null = require_null2();
  var seq = require_seq2();
  var string = require_string2();
...
var require_stringifyDocument2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var stringify = require_stringify2();
  var stringifyComment = require_stringifyComment2();
  function stringifyDocument(doc, options) {
...
var require_Document2 = __commonJS((exports2) => {
  var Alias = require_Alias2();
  var Collection = require_Collection2();
  var identity = require_identity2();
  var Pair = require_Pair2();
...
var require_resolve_props2 = __commonJS((exports2) => {
  function resolveProps(tokens, { flow, indicator, next, offset, onError, parentIndent, startOnNewline }) {
    let spaceBefore = false;
    let atNewline = startOnNewline;
    let hasSpace = startOnNewline;
...
var require_util_contains_newline2 = __commonJS((exports2) => {
  function containsNewline(key) {
    if (!key)
      return null;
    switch (key.type) {
...
var require_util_flow_indent_check2 = __commonJS((exports2) => {
...
var require_util_map_includes2 = __commonJS((exports2) => {
  var identity = require_identity2();
  function mapIncludes(ctx, items, search) {
    const { uniqueKeys } = ctx.options;
    if (uniqueKeys === false)
...
var require_resolve_block_map2 = __commonJS((exports2) => {
  var Pair = require_Pair2();
  var YAMLMap = require_YAMLMap2();
...
var require_resolve_block_seq2 = __commonJS((exports2) => {
  var YAMLSeq = require_YAMLSeq2();
  var resolveProps = require_resolve_props2();
  var utilFlowIndentCheck = require_util_flow_indent_check2();
  function resolveBlockSeq({ composeNode, composeEmptyNode }, ctx, bs, onError, tag) {
...
var require_resolve_end2 = __commonJS((exports2) => {
  function resolveEnd(end, offset, reqSpace, onError) {
    let comment = "";
    if (end) {
      let hasSpace = false;
...
var require_resolve_flow_collection2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var Pair = require_Pair2();
  var YAMLMap = require_YAMLMap2();
  var YAMLSeq = require_YAMLSeq2();
...
var require_compose_collection2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var Scalar = require_Scalar2();
  var YAMLMap = require_YAMLMap2();
  var YAMLSeq = require_YAMLSeq2();
...
var require_resolve_block_scalar2 = __commonJS((exports2) => {
  var Scalar = require_Scalar2();
  function resolveBlockScalar(ctx, scalar, onError) {
    const start = scalar.offset;
    const header = parseBlockScalarHeader(scalar, ctx.options.strict, onError);
...
var require_resolve_flow_scalar2 = __commonJS((exports2) => {
  var Scalar = require_Scalar2();
  var resolveEnd = require_resolve_end2();
  function resolveFlowScalar(scalar, strict, onError) {
    const { offset, type, source, end } = scalar;
...
var require_compose_scalar2 = __commonJS((exports2) => {
  var identity = require_identity2();
  var Scalar = require_Scalar2();
...
var require_util_empty_scalar_position2 = __commonJS((exports2) => {
  function emptyScalarPosition(offset, before, pos) {
    if (before) {
      pos ?? (pos = before.length);
      for (let i = pos - 1;i >= 0; --i) {
...
var require_compose_node2 = __commonJS((exports2) => {
  var Alias = require_Alias2();
  var identity = require_identity2();
...
var require_compose_doc2 = __commonJS((exports2) => {
...
var require_cst_scalar2 = __commonJS((exports2) => {
  var resolveBlockScalar = require_resolve_block_scalar2();
  var resolveFlowScalar = require_resolve_flow_scalar2();
  var errors = require_errors2();
  var stringifyString = require_stringifyString2();
...
var require_cst_stringify2 = __commonJS((exports2) => {
  var stringify = (cst) => ("type" in cst) ? stringifyToken(cst) : stringifyItem(cst);
  function stringifyToken(token) {
    switch (token.type) {
      case "block-scalar": {
...
var require_cst_visit2 = __commonJS((exports2) => {
  var BREAK = Symbol("break visit");
  var SKIP = Symbol("skip children");
  var REMOVE = Symbol("remove item");
  function visit(cst, visitor) {
...
var require_cst2 = __commonJS((exports2) => {
...
var require_lexer2 = __commonJS((exports2) => {
...
var require_line_counter2 = __commonJS((exports2) => {
  class LineCounter {
    constructor() {
      this.lineStarts = [];
      this.addNewLine = (offset) => this.lineStarts.push(offset);
...
var require_public_api2 = __commonJS((exports2) => {
...
// Releases/vACTIVE/.claude/hooks/lib/vendor/_bundle-entry.ts
var exports__bundle_entry = {};
__export(exports__bundle_entry, {
  writeFrontmatterField: () => writeFrontmatterField,
  parseYaml: () => import_yaml2.parse,
  parseSections: () => parseSections,
  parsePRDFile: () => parsePRDFile,
  parsePRDContent: () => parsePRDContent,
  parseFrontmatter: () => parseFrontmatter,
  parseCriteriaList: () => parseCriteriaList,
  getScalarField: () => getScalarField,
  detectFormatVersion: () => detectFormatVersion,
  countCriteria: () => countCriteria,
  classifySectionOrder: () => classifySectionOrder,
  VNEXT_SECTION_ORDER: () => VNEXT_SECTION_ORDER,
  V2_SECTION_ORDER: () => V2_SECTION_ORDER
});
module.exports = __toCommonJS(exports__bundle_entry);

// Packs/prd/src/Parser/index.ts
var import_fs = require("fs");

// Packs/prd/src/Parser/frontmatter.ts
var import_yaml = __toESM(require_dist(), 1);
function sanitizeYamlFrontmatter(raw) {
  return raw.split(`
`).map((line) => {
...
function legacyLineBasedParse(frontmatterBody) {
  const fm = {};
...
function parseFrontmatter(content) {
  ...
  let parsed;
  try {
    parsed = import_yaml.default.parse(sanitizeYamlFrontmatter(match[1]), { uniqueKeys: false });
  } catch {
...
function getScalarField(fm, name) {
  if (!fm)
    return;
  const v = fm[name];
  return typeof v === "string" ? v : undefined;
}
function writeFrontmatterField(content, field, value) {
...
// Packs/prd/src/Parser/criteria.ts
function countCriteria(content) {
...
function parseCriteriaList(content) {
  const criteriaMatch = content.match(/## Criteria[ \t]*\r?\n([\s\S]*?)(?=\n## |\n---|$)/);
  if (!criteriaMatch)
    return [];
  return criteriaMatch[1].split(`
`).filter((l) => l.match(/^- \[[ x]\]/)).flatMap((line, index) => {
    ...
    return [{
      ...
      isAnti,
      verificationMethod: command ? { type: "command", command } : /\b(test|lint|typecheck|verify|spec)\b/i.test(description) ? { type: "subjective", hint: "Verify via project test or lint evidence." } : { type: "subjective", hint: "Verify against the criterion description." },
      evidence,
...
// Packs/prd/src/Parser/sections.ts
var VNEXT_SECTION_ORDER = [
  "Problem",
  "Goal",
  "Out of Scope",
  "Principles",
...
function classifySectionOrder(sections) {
...
// Packs/prd/src/Parser/version.ts
function detectFormatVersion(content) {
  const fm = parseFrontmatter(content);
  if (!fm)
    return { status: "missing", version: 2 };
  const raw = getScalarField(fm, "format_version");
  if (raw === undefined)
    return { status: "missing", version: 2 };
  if (raw === "2")
    return { status: "valid", version: 2, raw: "2" };
  if (raw === "3")
    return { status: "valid", version: 3, raw: "3" };
  return { status: "invalid", raw };
}

// Packs/prd/src/Parser/index.ts
function parsePRDFile(path) {
  const content = import_fs.readFileSync(path, "utf-8");
  return parsePRDContent(content);
}
function v2SunsetActive() {
  ...
  try {
    ...
    for (const p of candidates) {
      ...
      if (status !== "accepted")
        return { active: false, reason: "RFC-0087 not accepted" };
      const sunset = content.match(/^[Ss]unset[- ]?date:\s*(\d{4}-\d{2}-\d{2})$/m)?.[1];
      if (!sunset)
        return { active: false, reason: "RFC-0087 has no sunset date" };
      const today = new Date().toISOString().slice(0, 10);
      if (today >= sunset)
        return { active: true, reason: `RFC-0087 sunset-date ${sunset} reached (today ${today})` };
...
function parsePRDContent(content) {
  ...
  if (version.status === "invalid") {
    throw new Error(`UnsupportedFormatVersion: format_version=${JSON.stringify(version.raw)} (closed enum {2, 3} per RFC-0080 \xA72.2)`);
  }
