...
description: Update the Fabric patterns library from the upstream repository.
status: STABLE
---
...
```bash
bash "$DOS_DIR/DOS/Tools/voice.sh" main "Updating Fabric patterns from upstream repository"
```
