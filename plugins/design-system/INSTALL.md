# DesignSystem v1.0.0 - Installation Guide
...
```
"I'm installing DesignSystem v1.0.0 -- AI-native design system management for Claude Code.

This pack adds:
- DESIGN.md paradigm for AI-readable design specifications
- Init workflow to create or extract design systems
- Update workflow to modify design tokens
- Generate workflow to build UI from tokens (no hallucinated colors)
- Audit workflow to check code against the design system
...
# Copy workflows
cp src/Workflows/Init.md "$SKILL_DIR/Workflows/"
cp src/Workflows/Update.md "$SKILL_DIR/Workflows/"
