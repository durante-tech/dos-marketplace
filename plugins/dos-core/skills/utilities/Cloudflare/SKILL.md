...
`~/.claude/DOS/USER/SKILLCUSTOMIZATIONS/Cloudflare/`
...
- **Pages:** UNSET ALL TOKENS - None of the API tokens have Pages permissions. OAuth-based wrangler login is the supported method that works.
