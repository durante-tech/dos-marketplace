...
**Think:** Smart conceptual diagram, but drafted technical and visually interesting

### Core Characteristics
1. **Clear structure** — Framework shape is recognizable (2x2, Venn, pyramid, etc.)
2. **Drafted technical** — Measured lines, measured circles, human touch
...
7. **Thoughtful color** — Strategic use of orange/navy to show relationships
...
```
Hot Accent Orange #F97316 — Concept area 1 or optimal quadrant
Blueprint Navy #1E3A8A — Concept area 2 or contrast quadrant
...
- Orange for "ideal" or primary concept
- Navy for "secondary" or contrast concept
...
3. **Color assignment:**
   - Which quadrant gets orange (optimal)
   - Which gets navy (contrast or secondary)
...
COLOR CODING:
- Top-right quadrant (optimal): Hot Accent Orange #F97316 accent
- Bottom-left quadrant (contrast): Blueprint Navy #1E3A8A accent
...
```
Drafted technical conceptual framework diagram in editorial style.
...
AESTHETIC:
- Drafted technical framework structure (measured lines, organic shapes)
- Variable stroke weight (axes thicker, details thinner)
- Measured but intentional geometry (circles not perfect, axes slightly wavy)
...
- Two drafted technical perpendicular axes (black) forming cross
...
- Color: Hot Accent Orange (#F97316) subtle accent/highlight — OPTIMAL ZONE
- Annotation: "*ideal state*" in orange italic
...
- Label: "[Name]"
- Description: [What this represents]
- Color: Blueprint Navy (#1E3A8A) subtle accent — CONTRAST ZONE
...
- Hot Accent Orange (#F97316) for [optimal zone] — subtle fill or accent
- Blueprint Navy (#1E3A8A) for [contrast zone] — subtle accent
- Blueprint Navy (#1E3A8A) for all text except emphasized annotations

CRITICAL REQUIREMENTS:
- Drafted measured geometry (NOT digital precision)
...
bun Tools/dos-image.ts "[YOUR PROMPT]" \
  ...
  --size=1024x1024 \
  --telemetry-tag=Media/Art/Frameworks
```
...
- [ ] **Drafted technical aesthetic** — Measured lines, organic shapes, human quality
- [ ] **Strategic color** — Orange on optimal zone, navy on contrast, not everywhere
...
| Problem | Fix |
|---------|-----|
| Too precise/digital | "Drafted measured axes, organic measured circles, human engineering-drawing quality" |
| Text unreadable | Increase label sizes, simplify annotations |
| Over-colored | "Subtle orange accent on optimal zone only, rest black structure" |
| Confusing structure | Simplify framework, stronger geometry cues |
| Looks corporate | Reference "editorial conceptual illustration, NASA / Tufte / patent diagrams style" |
...
- Optimal zone: Orange (subtle accent)
- Contrast zone: Navy (subtle accent)
- Text: Navy (except emphasized annotations)
