...
// Type exports
export type DOSTheme = typeof DOS_THEME
export type DOSColors = typeof DOS_THEME.colors
export type DOSTypography = typeof DOS_THEME.typography
export type DOSAnimation = typeof DOS_THEME.animation

// Utility: Get interpolate input/output for fade
export const fadeInterpolation = (startFrame = 0) => ({
  inputRange: [startFrame, startFrame + DOS_THEME.animation.fadeFrames],
...
export const titleScreenStyle = {
  ...
  fontFamily: DOS_THEME.typography.fontFamily,
}
