...
## 2026-07-10 — Enhance.md removed (operator-signed, Tailor Gen 50)

`Workflows/Enhance.md` was unadapted upstream boilerplate untouched since v0.0.1: it piped
through a nonexistent `enhance-content` shell command and hardcoded `/cms/blog/` paths that
never existed on this system. Deleted with its routing row (Content Enhancement section keeps
ExtractKnowledge). Original preserved at `tailor/MUTATIONS/gen-050-backups/Enhance.md`.
