...
> Verdict contract (Gen 69): the debate CLOSES with the typed JSON verdict block defined in
> `Workflows/Debate.md` Step 5, and the transcript+verdict PERSIST to
> `MEMORY/ARTIFACTS/council/<date>-<slug>.md`. The transcript shape below feeds that file.
