...
**Code-based replacement for legacy token-heavy MCP calls.**
...
**Legacy MCP Approach** (~57,000 tokens):
```
1. Search actors → 1,000 tokens result
2. Call actor → 1,000 tokens result
3. Get actor output → 50,000 tokens unfiltered dataset
```
