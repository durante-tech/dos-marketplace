---
name: Review Stories
description: Validate user stories in parallel with headless browser checks and pass/fail reporting.
status: STABLE
---
...
- **8-agent limit.** Matches DOS's parallel agent guidance and avoids resource contention.
