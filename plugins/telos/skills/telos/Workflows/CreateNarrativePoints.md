---
name: Create Narrative Points
description: Generates a story-driven consulting narrative across eight sections — opening context, bad news, evidence, stakes, pivot, requirements, vision, and close — from TELOS context.
status: STABLE
bestPath:
  - title: "Gather TELOS Context"
    description: "Scan the source for the client's ask, mission, current state, evidence, and stakes."
  - title: "Identify the Emotional Core"
    description: "Determine the fears, suspicions, worst outcomes, and vision that shape the arc."
  - title: "Draft Each Section"
    description: "Write all eight sections in order, from opening context through the close."
  - title: "Validate the Arc"
    description: "Check the emotional arc for tension, release, and returned agency."
---
...
- User says "create narrative", "narrative points", "TELOS report", or "n=24"
- A TELOS assessment (interviews, findings, or direct analysis) exists and needs to be turned into a story-driven deliverable for a board or executive audience
- User wants slide-ready or briefing-ready output rather than a bullet-point summary
